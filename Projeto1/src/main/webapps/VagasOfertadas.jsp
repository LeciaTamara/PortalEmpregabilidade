...
<div vw class="enabled">
  ...
  <main>
    ...
    <div class="content">
      ...
      <form id="form" action="mostrarVaga">
      ...
      <p> Titúlo da vaga: <%=vaga.getTitulo()%></p>
      <p> Descrição da vaga: <%=vaga.getDescricao()%></p>
      <p>Requisitos da Vaga: <%=vaga.getRequisito() %></p>
      <p> Salário: <%=vaga.getSalario() %></p>
      <p> Localização: <%=vaga.getLocalizacao() %></p>
      <p> Acessibilidade: <%=vaga.getAcessibilidade() %></p>
      <p> Data de expiração: <%=vaga.getDataExpiracao() %></p>
      <%}%>
      <%} %><%else{%>
